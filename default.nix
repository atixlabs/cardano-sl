...
let
  ...
  cardanoPkgs = ((import ./pkgs { inherit pkgs; }).override {
    overrides = self: super: {
      ...
      cardano-sl-generator = dontCheck super.cardano-sl-generator;
      ...
      cardano-sl-blockchain-importer-static = dontCheck (addGitRev (justStaticExecutables self.cardano-sl-blockchain-importer));
